# Generated by Django 3.2 on 2022-01-08 08:10
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0004_auto_20220107_0947'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'Формируется'), ('STP', 'Отправлен в обработку'), ('PRD', 'Обработан'), ('PD', 'Оплачен'), ('CNL', 'Отменен'), ('DN', 'Завершен')], default='FM', max_length=5)),
